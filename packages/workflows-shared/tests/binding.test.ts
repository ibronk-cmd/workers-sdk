...
import { WorkflowBinding, WorkflowHandle } from "../src/binding";
...
describe("WorkflowBinding", () => {
	...
	describe("createBatch()", () => {
		it("should create multiple instances in a batch", async () => {
			const binding = createBinding();
...
describe("WorkflowHandle", () => {
	...
	describe("terminate()", () => {
		it("should terminate a running workflow instance", async () => {
			const binding = createBinding();
			const engineStub = env.ENGINE.get(
				env.ENGINE.idFromName("some-instance-id")
			);
	...
	describe("restart()", () => {
		it("should restart a workflow instance", async () => {
			const binding = createBinding();
			const engineStub = env.ENGINE.get(
				env.ENGINE.idFromName("some-instance-id")
			);
			...
			let statusAfterRestart = await instance.status();
	...
	describe("pause()", () => {
		it("should pause a running workflow between steps", async () => {
			const binding = createBinding();
			const engineStub = env.ENGINE.get(
				env.ENGINE.idFromName("some-instance-id")
			);
